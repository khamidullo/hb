...
public class SortableReportByReservationForHotelDataProvider extends SortableDataProvider<ReservationDetail, String>
		implements IFilterStateLocator<AllReservationFilter> {
	private static final long serialVersionUID = 1L;
	private static Logger _log = LoggerFactory.getLogger(SortableReportByReservationForHotelDataProvider.class);
	private AllReservationFilter filter;

	public SortableReportByReservationForHotelDataProvider() {
	...
	public Iterator<ReservationDetail> iterator(long offset, long limit) {
		...
		try {
			...
			list = new MyBatisHelper().selectList("selectReservationsReportListForHotel", param);
