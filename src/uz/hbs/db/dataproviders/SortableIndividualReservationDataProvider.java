...
public class SortableIndividualReservationDataProvider extends SortableDataProvider<ReservationDetail, String> implements IFilterStateLocator<ReservationFilter> {
	private static final long serialVersionUID = 1L;
	private static Logger _log = LoggerFactory.getLogger(SortableIndividualReservationDataProvider.class);
	private ReservationFilter filter;
	
	public SortableIndividualReservationDataProvider() {
	...
	public Iterator<ReservationDetail> iterator(long offset, long limit) {
		...
		try {
			...
			param.put("is_group", ReservationDetail.INDIVIDUAL);
