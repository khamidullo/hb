...
/**
 * <p>
 * A "pure" client side stateless tabs component. You use it as you would use {@link TabbedPanel}, but instead of generating links that trigger server
 * round trips id does generates just "client side" links.
 * </p>
 * 
...
public class ClientSideBootstrapTabbedPanel<T extends ITab> extends GenericPanel<Integer> {
	 ...
	 *            The model saying which tab is the current active one
	 */
	 ...
	 * @param id
	 * @param href
	 *            The href (id) of the corresponding tab's content.
	 * @param tabIndex
	 *            The index of the tab
	 * @return
	 */
	 ...
	 * 
	 * @param id
	 *            The component id fo the content's container
	 ...
	 *
	 * @param id
	 *            The component id of the tabs container
