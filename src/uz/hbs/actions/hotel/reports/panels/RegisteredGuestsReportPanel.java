...
public class RegisteredGuestsReportPanel extends ReservationReportPanel {
	...
	public RegisteredGuestsReportPanel(String id, IBreadCrumbModel breadCrumbModel, final ValueMap model) {
		...
		final AJAXDownload download = new AJAXDownload() {
			...
			protected String getFileName() {
				return "RegisteredGuests_" + FormatUtil.toString(new Date(), MyWebApplication.DATE_FORMAT) + ".xlsx";
			}
		};
		add(download);
