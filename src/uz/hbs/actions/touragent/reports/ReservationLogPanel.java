...
public class ReservationLogPanel extends MyBreadCrumbPanel {
	private static final long serialVersionUID = 1L;

	public ReservationLogPanel(String id, IBreadCrumbModel breadCrumbModel, final Long reservationId) {
		...
		add(new ListView<ReservationLog>("loglist", new LoadableDetachableModel<List<ReservationLog>>() {
			...
			protected List<ReservationLog> load() {
				return new MyBatisHelper().selectList("selectReservationLogs", reservationId);
			}
		}) {
			private static final long serialVersionUID = 1L;
