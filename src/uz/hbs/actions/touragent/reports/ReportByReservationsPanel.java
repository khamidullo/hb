...
import uz.hbs.db.dataproviders.SortableReportByReservationForTouragentDataProvider;
...
public class ReportByReservationsPanel extends MyBreadCrumbPanel {
	...
	public ReportByReservationsPanel(String id, IBreadCrumbModel breadCrumbModel) {
		...
		filter.setUser_type(User.TYPE_TOURAGENT_USER);
		filter.setTourAgent(new IdLongAndName(getMySession().getUser().getId()));
		...
		*/
		...
		final SortableReportByReservationForTouragentDataProvider provider = new SortableReportByReservationForTouragentDataProvider();
...
*/							
							...
							List<ReservationDetail> list = new MyBatisHelper().selectList("selectReservationsReportListForTouragent", param);
