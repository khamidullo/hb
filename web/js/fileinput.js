...
(function ($) {
    var MAIN_TEMPLATE_1 = '{preview}\n' +
        ...
        MODAL_TEMPLATE = '<div id="{id}" class="modal fade">\n' +
            ...
            '        <h3 class="modal-title">Подробный просмотр <small>{title}</small></h3>\n' +
            '      </div>\n' +
    ...
    $.fn.fileinput.defaults = {
        ...
        browseLabel: 'Обзор &hellip;',//'Browse &hellip;'
        browseIcon: '<i class="fa fa-folder-open fa-fw"></i> &nbsp;',
        browseClass: 'btn btn-primary',
        removeLabel: 'Удалить',//'Remove'
        removeIcon: '<i class="fa fa-times-circle fa-fw"></i> ',
        removeClass: 'btn btn-default',
        uploadLabel: 'Загрузить',//'Upload'
        uploadIcon: '<i class="fa fa-upload fa-fw"></i> ',
        uploadClass: 'btn btn-default',
        uploadUrl: null,
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'Файл "{name}" (<b>{size} KB</b>) превышает максимально допустимый размер загрузки <b>{maxSize} KB</b>. Пожалуйста, повторите попытку загрузки!',//'File "{name}" (<b>{size} KB</b>) exceeds maximum allowed upload size of <b>{maxSize} KB</b>. Please retry your upload!'
        msgFilesTooMany: 'Количество файлов, выбранных для загрузки <b>({n})</b> превышает максимально допустимую лимит <b>{m}</b>. Пожалуйста, повторите попытку загрузки!',//'Number of files selected for upload <b>({n})</b> exceeds maximum allowed limit of <b>{m}</b>. Please retry your upload!'
        msgFileNotFound: 'Файл "{name}" не найден!',//'File "{name}" not found!'
        msgFileNotReadable: 'Файл "{name}" недоступен для чтения.',//'File "{name}" is not readable.'
        msgFilePreviewAborted: 'Предварительный просмотр для файла "{name} прервана.',//'File preview aborted for "{name}".'
        msgFilePreviewError: 'Произошла ошибка при чтении файла "{name}".',//'An error occurred while reading the file "{name}".'
        msgValidationError: '<span class="text-danger"><i class="fa fa-exclamation-circle fa-fw"></i> File Upload Error</span>',
        msgErrorClass: 'file-error-message',
        msgLoading: 'Загрузка файла {index} из {files} &hellip;',//'Loading  file {index} of {files} &hellip;'
        msgProgress: 'Загрузка файла {index} из {files} - {name} - {percent}% завершено.',//'Loading file {index} of {files} - {name} - {percent}% completed.'
        msgSelected: '{n} файлы выбраны',//'{n} files selected'
